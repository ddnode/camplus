<div class="node-comment">
	<div class="comments-group">
		<div class="comment stbody">
			...
			<div class="sttext comment-detail">
				<div class="comment-info"><div class="level fr"><a href="#">@1</a><span>1楼</span></div><a href="#" class="comment-name">大漠</a></div>
				<div class="comment-content">
					容不是道德，而是认识。唯有深刻地认识事物，才能对人和世界的复杂性有了解和体谅，才有不轻易责难和赞美的思维习惯。
				</div>
				<!-- end comment content -->
				<div class="comment-footer clearfix">
					<ul class="clearfix unstyled comment-handle fr">
						<li><a href="#"><i class="icon icon-like"></i>赞好(<span class="like-num">20</span>)</a></li>
						<li><a href="#"><i class="icon icon-hate"></i>踩(<span class="like-num">20</span>)</a></li>
						<li><a href="#">举报</a></li>
						<li><a href="#">回应</a></li>						
					</ul>
	...
	<div class="comments-group">
		<div class="comment stbody">
			<div class="stimg stimgL avatar"><a href="#"><img src="http://www.w3cplus.com/sites/default/files/styles/user_picture/public/pictures/picture-1-1347153884.jpg" alt="avatar" width="30" height="30"></a></div>
			<!-- end user face -->
			<div class="sttext comment-detail">
				<div class="comment-info"><div class="level fr"><a href="#">@2</a><span>2楼</span></div><a href="#" class="comment-name">大漠</a></div>
				<div class="comment-content">
					容不是道德，而是认识。唯有深刻地认识事物，才能对人和世界的复杂性有了解和体谅，才有不轻易责难和赞美的思维习惯。
				</div>
				<!-- end comment content -->
				...
				<div class="comment-children">
					<div class="comment stbody comment-children-list">
						...
						<div class="sttext comment-detail">
							...
							<div class="comment-footer clearfix">						
								<div class="comment-from fl">
									<a href="#">今天 22:27</a><a href="#" class="del">删除</a>
								</div>
							</div>
							<!-- end content footer -->					
						</div>
